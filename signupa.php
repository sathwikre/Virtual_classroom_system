...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO useradmin(username, email, password) VALUES ('$username', '$email', '$password')";

    if ($conn->query($sql) === TRUE) {
        echo "<p style='color: green;'>Registration successful! Redirecting to login page...</p>";
        header("Refresh: 2; url=logint.php"); 
    } else {
...
<body>
    <div class="signup-container">
        ...
        <p>Already have an account? <a href="logint.php">Login here</a></p>
    </div>
</body>
</html>
